...
;layui.define("view", function (e) {
    var a = layui.jquery, i = layui.laytpl, t = layui.element, l = layui.setter, n = layui.view,
        s = layui.device(), r = a(window), o = a("body"), u = a("#" + l.container),
        d = "layui-show", c = "layui-hide", y = "layui-this", f = "layui-disabled",
        h = "#LAY_app_body", m = "LAY_app_flexible", p = "layadmin-layout-tabs",
        ...
        x = "layui-icon-spread-left", C = "layadmin-side-shrink", k = "LAY-system-side-menu", F = {
            v: "1.2.1 std", req: n.req, sendAuthCode: function (e) {
                ...
                var t = (l.theme, layui.data(l.tableName)), n = "LAY_layadmin_theme",
            ...
            flexible: function (e) {
                ...
                var t = a("#LAY_app_tabsheader"), l = t.children("li"),
                    n = (t.prop("scrollWidth"), t.outerWidth()), s = parseFloat(t.css("left"));
                if ("left" === e) {
                    if (!s && s <= 0) return;
                    var r = -s - n;
                    l.each(function (e, i) {
        ...
        var i = e.url, t = function (e) {
            ...
            e.each(function (e, l) {
                ...
                if (o.each(function (e, l) {
                    var s = a(l), r = t(s), o = r.list.children("dd"),
    ...
    o.on("click", z, function () {
        ...
        if (!e.parent().hasClass("layui-nav-item") || u.hasClass(C)) {
            var i = e.attr("lay-tips"), t = e.attr("lay-offset"), l = e.attr("lay-direction"),
                n = layer.tips(i, this, {
